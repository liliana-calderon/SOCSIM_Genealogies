...
asfr_less_children_1_25 <- map_dfr(less_children_1_25, ~ estimate_fertility_rates_mod(opop = .x,
                                                                                      final_sim_year = 2072, 
                                                                                      year_min = 1750, 
                                                                                      year_max = 2020, 
                                                                                      year_group = 5,
...
asmr_less_children_1_25 <- map_dfr(less_children_1_25, ~ estimate_mortality_rates_mod(opop = .x,
                                                                                      final_sim_year = 2072, 
                                                                                      year_min = 1750, 
                                                                                      year_max = 2020, 
                                                                                      year_group = 5,
...
asfr_less_children_1_50 <- map_dfr(less_children_1_50, ~ estimate_fertility_rates_mod(opop = .x,
                                                                                      final_sim_year = 2072, 
                                                                                      year_min = 1750, 
                                                                                      year_max = 2020, 
                                                                                      year_group = 5,
...
asmr_less_children_1_50 <- map_dfr(less_children_1_50, ~ estimate_mortality_rates_mod(opop = .x,
                                                                                      final_sim_year = 2072, 
                                                                                      year_min = 1750, 
                                                                                      year_max = 2020, 
                                                                                      year_group = 5,
...
asfr_less_children_1_75 <- map_dfr(less_children_1_75, ~ estimate_fertility_rates_mod(opop = .x,
                                                                                      final_sim_year = 2072, 
                                                                                      year_min = 1750, 
                                                                                      year_max = 2020, 
                                                                                      year_group = 5,
...
asmr_less_children_1_75 <- map_dfr(less_children_1_75, ~ estimate_mortality_rates_mod(opop = .x,
                                                                                      final_sim_year = 2072, 
                                                                                      year_min = 1750, 
                                                                                      year_max = 2020, 
                                                                                      year_group = 5,
...
# Estimate age-specific fertility rates from the subset without 75% children dead below age 1
asfr_less_children_1_100 <- map_dfr(less_children_1_100, ~ estimate_fertility_rates_mod(opop = .x,
                                                                                        final_sim_year = 2072, 
                                                                                        year_min = 1750, 
                                                                                        year_max = 2020, 
                                                                                        year_group = 5,
...
asmr_less_children_1_100 <- map_dfr(less_children_1_100, ~ estimate_mortality_rates_mod(opop = .x,
                                                                                        final_sim_year = 2072, 
                                                                                        year_min = 1750, 
                                                                                        year_max = 2020, 
                                                                                        year_group = 5,
...
asfr_less_children_5_25 <- map_dfr(less_children_5_25, ~ estimate_fertility_rates_mod(opop = .x,
                                                                                      final_sim_year = 2072, 
                                                                                      year_min = 1750, 
                                                                                      year_max = 2020, 
                                                                                      year_group = 5,
...
asmr_less_children_5_25 <- map_dfr(less_children_5_25, ~ estimate_mortality_rates_mod(opop = .x,
                                                                                      final_sim_year = 2072, 
                                                                                      year_min = 1750, 
                                                                                      year_max = 2020, 
                                                                                      year_group = 5,
...
asfr_less_children_5_50 <- map_dfr(less_children_5_50, ~ estimate_fertility_rates_mod(opop = .x,
                                                                                      final_sim_year = 2072, 
                                                                                      year_min = 1750, 
                                                                                      year_max = 2020, 
                                                                                      year_group = 5,
...
asmr_less_children_5_50 <- map_dfr(less_children_5_50, ~ estimate_mortality_rates_mod(opop = .x,
                                                                                      final_sim_year = 2072, 
                                                                                      year_min = 1750, 
                                                                                      year_max = 2020, 
                                                                                      year_group = 5,
...
asfr_less_children_5_75 <- map_dfr(less_children_5_75, ~ estimate_fertility_rates_mod(opop = .x,
                                                                                      final_sim_year = 2072, 
                                                                                      year_min = 1750, 
                                                                                      year_max = 2020, 
                                                                                      year_group = 5,
...
asmr_less_children_5_75 <- map_dfr(less_children_5_75, ~ estimate_mortality_rates_mod(opop = .x,
                                                                                      final_sim_year = 2072, 
                                                                                      year_min = 1750, 
                                                                                      year_max = 2020, 
                                                                                      year_group = 5,
...
asfr_less_children_5_100 <- map_dfr(less_children_5_100, ~ estimate_fertility_rates_mod(opop = .x,
                                                                                        final_sim_year = 2072, 
                                                                                        year_min = 1750, 
                                                                                        year_max = 2020, 
                                                                                        year_group = 5,
...
asmr_less_children_5_100 <- map_dfr(less_children_5_100, ~ estimate_mortality_rates_mod(opop = .x,
                                                                                        final_sim_year = 2072, 
                                                                                        year_min = 1750, 
                                                                                        year_max = 2020, 
                                                                                        year_group = 5,
...
bind_rows(asfr_whole2, asfr_less_children_1_25b, asfr_less_children_1_50b, asfr_less_children_1_75b, asfr_less_children_1_100b, 
  ...
  theme_graphs()
ggsave(file="Graphs/Socsim_Exp3A_ASFR.jpeg", width=17, height=9, dpi=300)
...
bind_rows(asmr_whole2, asmr_less_children_1_25b, asmr_less_children_1_50b, asmr_less_children_1_75b,  asmr_less_children_1_100b, 
  ...
  scale_y_log10() +
  theme_graphs()
ggsave(file="Graphs/Socsim_Exp3A_ASMR.jpeg", width=17, height=9, dpi=300)
...
bind_rows(asfr_whole2 %>% rename(Estimate = ASFR), 
  ...
  theme(legend.title = element_text(size = 20),
        legend.text = element_text(size = 18))
ggsave(file="Final_Graphs/Fig9.pdf", width=18, height=23, dpi=300, device = "pdf")
#----------------------------------------------------------------------------------------------------
...
asfr_less_children_1_25_1 <- map_dfr(less_children_1_25, ~ estimate_fertility_rates_mod(opop = .x,
                                                                                        final_sim_year = 2072, 
                                                                                        year_min = 1750, 
                                                                                        year_max = 2023, 
                                                                                        year_group = 1,
...
asfr_less_children_1_50_1 <- map_dfr(less_children_1_50, ~ estimate_fertility_rates_mod(opop = .x,
                                                                                        final_sim_year = 2072, 
                                                                                        year_min = 1750, 
                                                                                        year_max = 2023, 
                                                                                        year_group = 1,
...
asfr_less_children_1_75_1 <- map_dfr(less_children_1_75, ~ estimate_fertility_rates_mod(opop = .x,
                                                                                        final_sim_year = 2072, 
                                                                                        year_min = 1750, 
                                                                                        year_max = 2023, 
                                                                                        year_group = 1,
...
asfr_less_children_1_100_1 <- map_dfr(less_children_1_100, ~ estimate_fertility_rates_mod(opop = .x,
                                                                                          final_sim_year = 2072, 
                                                                                          year_min = 1750, 
                                                                                          year_max = 2023, 
                                                                                          year_group = 1,
...
asfr_less_children_5_25_1 <- map_dfr(less_children_5_25, ~ estimate_fertility_rates_mod(opop = .x,
                                                                                        final_sim_year = 2072, 
                                                                                        year_min = 1750, 
                                                                                        year_max = 2023, 
                                                                                        year_group = 1,
...
asfr_less_children_5_50_1 <- map_dfr(less_children_5_50, ~ estimate_fertility_rates_mod(opop = .x,
                                                                                        final_sim_year = 2072, 
                                                                                        year_min = 1750, 
                                                                                        year_max = 2023, 
                                                                                        year_group = 1,
...
asfr_less_children_5_75_1 <- map_dfr(less_children_5_75, ~ estimate_fertility_rates_mod(opop = .x,
                                                                                        final_sim_year = 2072, 
                                                                                        year_min = 1750, 
                                                                                        year_max = 2023, 
                                                                                        year_group = 1,
...
asfr_less_children_5_100_1 <- map_dfr(less_children_5_100, ~ estimate_fertility_rates_mod(opop = .x,
                                                                                          final_sim_year = 2072, 
                                                                                          year_min = 1750, 
                                                                                          year_max = 2023, 
                                                                                          year_group = 1,
...
bind_rows(TFR_whole, TFR_anc_off,
  ...
  theme_graphs() 
ggsave(file="Graphs/Socsim_Exp3A_TFR.jpeg", width=17, height=9, dpi=300)
...
error_TFR_exp3A %>% 
  ...
  geom_line(linewidth = 1.3)+
  theme_graphs()
ggsave(file="Graphs/Socsim_Exp3A_TFR_Error.jpeg", width=17, height=9, dpi=300)
...
error_TFR_exp3A %>% 
  ...
  geom_line(linewidth = 1.3)+
  theme_graphs()
ggsave(file="Graphs/Socsim_Exp3A_TFR_Rel_Error.jpeg", width=17, height=9, dpi=300)
...
error_TFR_exp3A %>% 
  filter(Year < 1900) %>% 
  filter(Dataset == "25% Omission") %>% # -0.03593353
  # filter(Dataset == "100% Omission") %>% # -0.9446202
  pull(Error) %>% 
  mean()
...
error_TFR_exp3A %>% 
  filter(Year < 1900) %>% 
  filter(Dataset == "25% Omission") %>% # -0.7332323
  # filter(Dataset == "100% Omission") %>% # -20.90459
  pull(Relative_Error) %>% 
  mean()
...
# Estimate age-specific mortality rates from the subset without 25% children dead below age 1
asmr_less_children_1_25_1 <- map_dfr(less_children_1_25, ~ estimate_mortality_rates_mod(opop = .x,
                                                                                        final_sim_year = 2072, 
                                                                                        year_min = 1750, 
                                                                                        year_max = 2023, 
                                                                                        year_group = 1,
...
# Estimate age-specific mortality rates from the subset without 50% children dead below age 1
asmr_less_children_1_50_1 <- map_dfr(less_children_1_50, ~ estimate_mortality_rates_mod(opop = .x,
                                                                                        final_sim_year = 2072, 
                                                                                        year_min = 1750, 
                                                                                        year_max = 2023, 
                                                                                        year_group = 1,
...
# Estimate age-specific mortality rates from the subset without 75% children dead below age 1
asmr_less_children_1_75_1 <- map_dfr(less_children_1_75, ~ estimate_mortality_rates_mod(opop = .x,
                                                                                        final_sim_year = 2072, 
                                                                                        year_min = 1750, 
                                                                                        year_max = 2023, 
                                                                                        year_group = 1,
...
# Estimate age-specific mortality rates from the subset without 100% children dead below age 1
asmr_less_children_1_100_1 <- map_dfr(less_children_1_100, ~ estimate_mortality_rates_mod(opop = .x,
                                                                                          final_sim_year = 2072, 
                                                                                          year_min = 1750, 
                                                                                          year_max = 2023, 
                                                                                          year_group = 1,
...
# Estimate age-specific mortality rates from the subset without 25% children dead below age 5
asmr_less_children_5_25_1 <- map_dfr(less_children_5_25, ~ estimate_mortality_rates_mod(opop = .x,
                                                                                        final_sim_year = 2072, 
                                                                                        year_min = 1750, 
                                                                                        year_max = 2023, 
                                                                                        year_group = 1,
...
# Estimate age-specific mortality rates from the subset without 50% children dead below age 5
asmr_less_children_5_50_1 <- map_dfr(less_children_5_50, ~ estimate_mortality_rates_mod(opop = .x,
                                                                                        final_sim_year = 2072, 
                                                                                        year_min = 1750, 
                                                                                        year_max = 2023, 
                                                                                        year_group = 1,
...
# Estimate age-specific mortality rates from the subset without 75% children dead below age 5
asmr_less_children_5_75_1 <- map_dfr(less_children_5_75, ~ estimate_mortality_rates_mod(opop = .x,
                                                                                        final_sim_year = 2072, 
                                                                                        year_min = 1750, 
                                                                                        year_max = 2023, 
                                                                                        year_group = 1,
...
# Estimate age-specific mortality rates from the subset without 100% children dead below age 5
asmr_less_children_5_100_1 <- map_dfr(less_children_5_100, ~ estimate_mortality_rates_mod(opop = .x,
                                                                                          final_sim_year = 2072, 
                                                                                          year_min = 1750, 
                                                                                          year_max = 2023, 
                                                                                          year_group = 1,
...
error_e0_exp3A %>%
  ...
  geom_line(linewidth = 1.3)+
  theme_graphs()
ggsave(file="Graphs/Socsim_Exp3A_e0_Error.jpeg", width=17, height=9, dpi=300)
...
error_e0_exp3A %>% 
  ...
  geom_line(linewidth = 1.3)+
  theme_graphs()
ggsave(file="Graphs/Socsim_Exp3A_e0_Rel_Error.jpeg", width=17, height=9, dpi=300)


# Check minimum and maximum values of bias in e0 over the whole period 
error_e0_exp3A %>% 
  filter(sex == "female") %>%
  filter(Dataset == "25% Omission") %>% # 2.600863
  #filter(Dataset == "100% Omission") %>% # 9.34501
  pull(Error) %>%
  mean()
...
error_e0_exp3A %>% 
  filter(sex == "female") %>%
  # filter(Dataset == "25% Omission") %>% # 5.779585
  filter(Dataset == "100% Omission") %>% # 21.94657
  pull(Relative_Error) %>% 
  mean()
...
Summary_Exp3A
# Save the plot
ggsave(file="Graphs/Socsim_Exp3A_TFR_e0.jpeg", width=17, height=9, dpi=300)
#----------------------------------------------------------------------------------------------------
...
By_Age_Exp3A + 
  ...
  geom_text(data = plot_labs2, mapping = aes(x = x, y = y, label = labels), inherit.aes = F, 
            size = 15, family="serif") +
  plot_layout(ncol = 1)
ggsave(file="Final_Graphs/Fig3.pdf", width=18, height=21, dpi=300, device = "pdf")